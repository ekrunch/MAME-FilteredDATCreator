<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- 2. The Exclusion Template: This rule overrides the Identity Template.
         ...
         These machines are FILTERED OUT (suppressed), ensuring ONLY machines with a 
         good driver status are SELECTed (kept) in the output. -->
    <xsl:template match="machine[not(driver[@status = 'good'])]"/>
